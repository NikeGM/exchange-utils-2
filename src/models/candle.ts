...
export class Candle {
	...
	public readonly finamCode: number;

	constructor(candleData: CandleData) {
		const { high, open, low, close, volume, period, typical, median, weightedClose, code, time, finamCode } = candleData;
